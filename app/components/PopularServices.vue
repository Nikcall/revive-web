...
const POPULAR: Record<string, string[]> = {
  'remont-noutbukov': [
    'Чистка системы охлаждения, замена термоинтерфейсов',
    'Замена матрицы/экрана (без стоимости матрицы)',
    'Замена клавиатуры (без стоимости клавиатуры)',
    'Замена аккумулятора (без стоимости аккумулятора)',
    'Замена HDD→SSD (без стоимости SSD)',
    'Ремонт/замена петель экрана',
  ],
  'remont-smartfonov': [
    'Замена дисплея',
    'Замена аккумулятора',
    'Чистка после залития',
    'Замена разъёма зарядки',
    'Замена заднего стекла',
    'Замена стекла',
  ],
  'remont-kompyuterov': [
    'Чистка корпуса и системы охлаждения',
    'Апгрейд HDD→SSD (без стоимости SSD)',
    'Установка/восстановление/клонирование Windows',
    'Замена блока питания (без стоимости БП)',
    'Апгрейд оперативной памяти (без стоимости)',
    'Удаление вирусов, рекламного ПО',
  ],
  'remont-planshetov': [
